...
public class Assets {
	...
	public void dispose() {
		Texture[] tex = new Texture[]{backgroundMiddle, background, diver, plant, boat, shark, joystickup, joystickunder, apple, paper, oil, air, black,restartButton,restartButton_hover};
		for(Texture t:tex){
			t.dispose();
		}
	}
